...
function setup() {
  ...
  TweenMax.to(mesh.rotation, 80, { z: 2 * Math.PI, ease: Linear.easeOut, repeat: -1 });

  //const gui = new dat.GUI();


  material.uniforms.speed, 'value', 0, 0.01;

  material.uniforms.waveDefinition, 'value', 0, 6;
  material.uniforms.waveAmplitude, 'value', 0, 1;

  material.uniforms.topoDefinition, 'value', 0, 30;
